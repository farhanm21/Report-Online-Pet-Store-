...
if (option == 2){
 // Create a pet store
    ...
    petStore.addPet(new Cat("Buddy", 3, "Persian"));
    petStore.addPet(new Dog("Rocky", 5, "Labrador"));
    petStore.addPet(new Fish("Nemo", 1, "Clownfish"));
    petStore.addPet(new Bird("Kiwi", 2, "Parakeet"));
    ...
    // Buy a pet
    int petIndex;
    cout << "Enter the index of the pet you want to buy: ";
    cin >> petIndex;
